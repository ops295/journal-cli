...
5. Answer the questions. Use Enter to save and advance. Use Shift+Right to move to the next question and Shift+Left to go back to the previous question. Ctrl+S or Ctrl+N still advances.
